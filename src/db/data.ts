...
export const jobInfo = [
    ...
    },
    {
        ...
        infoList: ["SZENYOR/SZTNYR adminisztrátor", "Személyügyi oldalon SZENYOR/KIRA interface kezelése", "Ügyfélkapu regisztrációs admin", "RVTV portál admin", "Egyéb adminisztrációs feladatok"]
    },
    {
...
export const educationInfo = [
    {
        ...
        infoList: ["FrontEnd: HTML5, CSS, Tailwind, Typescript/Javascript, REACT (ismerkedés szinten Angular, Vue, Svelte)", "Backend: Node.js, Express.js, PostgreSQL", "Verzió kezelés: Git / GitHub", "Egyéb library: Zod, Axios"]
    },
    {
        infoTitle: "Certa Kft.",
...
export const skills: string[] = ["Problémamegoldó képesség", "Csapatmunka", "Feladatorientált gondolkodás, magas szintű fókusz"] 